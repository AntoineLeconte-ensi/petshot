...
class srcDevDebugProjectContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        if (null === self::$declaredRoutes) {
            self::$declaredRoutes = [
        'app_phone_list' => [[], ['_controller' => 'App\\Controller\\PhoneController::listAction'], [], [['text', '/phone']], [], []],
        'app_phone_get' => [['imei'], ['_controller' => 'App\\Controller\\PhoneController::getAction'], [], [['variable', '/', '[^/]++', 'imei'], ['text', '/phone']], [], []],
        'app_phone_addphonedata' => [['imei'], ['_controller' => 'App\\Controller\\PhoneController::addPhoneDataAction'], [], [['variable', '/', '[^/]++', 'imei'], ['text', '/phone']], [], []],
