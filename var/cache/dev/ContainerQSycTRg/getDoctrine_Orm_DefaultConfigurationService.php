...
$instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Repository\\PhoneRepository' => function () {
    return ($this->privates['App\\Repository\\PhoneRepository'] ?? $this->load('getPhoneRepositoryService.php'));
}])));
