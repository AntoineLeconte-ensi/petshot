...
class __TwigTemplate_b17ddf38ca85d04a984c8999913ec0b3b01033e9ca10c459400fb3dec414a6fb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["log"], "priorityName", [], "any", false, false, false, 203) == "WARNING")) ? ("status-warning") : (""))))));
                ...
                echo "
                    <td class=\"font-normal\">";
                // line 223
                echo twig_call_macro($macros["helper"], "macro_render_log_message", [(isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 223, $this->source); })()), twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 223), $context["log"]], 223, $context, $this->getSourceContext());
                echo "</td>
                </tr>
            ";
                ++$context['loop']['index0'];
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "C:\\androbreaker\\androbreaker\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\logger.html.twig");
    }
}
